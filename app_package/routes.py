...
from app_package.forms import LoginForm, RegistrationForm, EditProfileForm
...
@app.before_request  # this records the last time a user was logged in
def before_request():
...
@app.route('/user/<username>') #the <username> here is dynamic content
@login_required
def user(username):
